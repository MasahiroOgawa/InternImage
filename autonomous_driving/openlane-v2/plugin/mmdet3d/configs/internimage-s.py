...
model = dict(
            ...
            decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        dict(type="MultiScaleDeformableAttention", embed_dims=_dim_),
                    ],
                    ffn_cfgs=_ffn_cfg_,
                    operation_order=(
                        "self_attn",
    ...
    lclc_head=dict(
        ...
        shared_param=False,
        loss_rel=dict(
            type="FocalLoss", use_sigmoid=True, gamma=2.0, alpha=0.25, loss_weight=5
        ),
    ),
    lcte_head=dict(
        type="RelationshipHead",
...
train_pipeline = [
    ...
    dict(
        type="CustomParameterizeLane",
        method="bezier_Endpointfixed",
