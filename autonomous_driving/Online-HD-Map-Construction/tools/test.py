...
def parse_args():
    ...
    parser.add_argument(
        "--split", type=str, required=True, help="which split to test on"
    )
    ...
    parser.add_argument(
        "--eval", action="store_true", help="whether to run evaluation."
    )
    parser.add_argument(
        "--gpu-collect",
        action="store_true",
...
def main():
    ...
    if samples_per_gpu > 1:
        ...
        cfg_data_dict.pipeline = replace_ImageToTensor(cfg_data_dict.pipeline)
