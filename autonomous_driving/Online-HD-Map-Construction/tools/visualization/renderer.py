...
def draw_polyline_ego_on_img(
    polyline_ego, img_bgr, extrinsics, intrinsics, color_bgr, thickness
):
...
class Renderer(object):
    ...
    def render_camera_views_from_vectors(
        self, vectors, imgs, extrinsics, intrinsics, thickness, out_dir
    ):
            ...
            for cat, vector_list in vectors.items():
                ...
                for vector in vector_list:
                    ...
                    draw_polyline_ego_on_img(
                        vector_array, img_bgr, extrinsic, intrinsic, color, thickness
                    )
