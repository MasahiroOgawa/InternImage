...
def parse_args():
    ...
    parser.add_argument(
        "detector_cfg_path", help="test config file path of MMDet detector"
    )
    parser.add_argument(
        "detector_ckpt_path", help="checkpoint file path of MMDet detector"
    )
    parser.add_argument(
        "sam_ckpt_path", default="vit_b", help="checkpoint file path of SAM"
    )
    parser.add_argument(
        "--sam_type", default="vit_b", help="test config file path of MMDet detector"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        nargs="+",
        help="ids of gpus to use " "(only applicable to non-distributed testing)",
    )
    parser.add_argument(
        "--format-only",
        action="store_true",
...
def main():
    ...
    if not distributed:
        ...
        sam = sam_model_registry[args.sam_type](checkpoint=args.sam_ckpt_path).to(
